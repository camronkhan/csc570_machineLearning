...
**Pruning**<br>
It appears the index is included as a feature that we will need to remove from our dataframe. We will consider additional features to prune later in the analysis.
